        ...
        if (!so->is_space_junk())
        {
            ...
            switch (so->material())
            {
                case Space_object::Material::metal: // spaceship
                    ...
                    pos.y -=space_ship_.dimensions().height* space_ship_scale_ / 2;
                ...
                case Space_object::Material::rock: // asteroid
                    {
                        ...
                        pos.x -=asteroid_.dimensions().width * asteroid_scale_  * ss->mass() / 2;
                        pos.y -=asteroid_.dimensions().height * asteroid_scale_  * ss->mass() / 2;
