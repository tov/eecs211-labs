...
\marginnote{\url{\PuTTYurl}}; be sure to get the
MSI installer, not just \texttt{putty.exe}, because you need
\texttt{pscp.exe} as well, and you need it installed in the right place.
...
hostnames\marginnote{\url{\LabHostnamesUrl}}
(such as 
...
a .tgz
\marginpar{
  The .tgz file extension is used for “gzipped tarballs”, which are like
  the Linux equivalent of .ZIP files.
}
