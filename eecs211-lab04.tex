...
When creating libraries and API's, it is very important to consider the case where your function gets a \varname{nullptr} inputted, as a \varname{nullptr} can't be de-referenced.
