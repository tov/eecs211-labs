...
Notice in the lab that we created a struct called \varname{Dog} which is located in our \filename{lab3.h} which has a few attributes.
...
Click on the \filename{$lab3_test.cpp$} file that we have provided in the project.  
